...
public class DeleteCustomer extends JFrame {
	...
	public DeleteCustomer() throws SQLException {
		...
		b1.addActionListener((ActionEvent e) -> {
                    ...
                    try {
                        ResultSet rs;
                        rs = c2.s.executeQuery("select * from customer where username = 'sahithi5102'");
                        if(rs.next()){
		...
		btnNewButton.addActionListener((ActionEvent e) -> {
                    Conn c2 = new Conn();
                    try {
                        c2.s.executeUpdate("delete from account where username = 'sahithi5102'");
                        c2.s.executeUpdate("delete from bookHotel where username = 'sahithi5102'");
                        c2.s.executeUpdate("delete from bookPackage where username = 'sahithi5102'");
                        c2.s.executeUpdate("delete from customer where username = 'sahithi5102'");
